...
SECRET_KEY = "django-insecure-szp!n#jdpn!%2(05-!js=-f_fk)fzrx@&gvvb^%jo)^0+4(4$7"
...
TEMPLATES = [
    {
        ...
        "APP_DIRS": True,
        "OPTIONS": {
            # los context processors "categoria" y "carrito"
            # se ejecutarán cada vez que se renderice una plantilla en respuesta a una solicitud
            "context_processors": [
...
# ? Configuracion del archivo static
STATIC_URL = "static/"
